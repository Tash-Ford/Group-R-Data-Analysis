...
```{r}
boxplot(salmonella_length, e_coli_length,
...
mean(salmonella_length)
```

```{r}
median(salmonella_length)
```
...
```
A data frame of 3 length K-mers was created for salmonella to be able to be able to sort over represented and underrepresented 3 length k-mers.
...
```
A data frame of 3 length K-mers was created for E.coli to be able to be able to sort over represented and underrepresented 3 length k-mers.
...
```
The 3 length K-mers overrepresented in Salmonella and E.coli, are all the same, and in the same order of overrepresentation, however they do vary on the amount of representation In the gene.
...
```
The 3 length K-mers underrepresented in Salmonella and E.coli, share similar K-mers, with majority of the K-mers shown being in both organism, with a few exceptions of ‘FKW’ in Salmonella and ‘MWN’ in E.coli, the shared K-mers do vary on the amount of representation In the gene.
...
```
A data frame of 4 length K-mers was created for salmonella to be able to be able to sort over represented and underrepresented 4 length k-mers.
...
```
A data frame of 4 length K-mers was created for E.coli to be able to be able to sort over represented and underrepresented 4 length k-mers.
...
```
The 4 length K-mers overrepresented in Salmonella and E.coli, share similar K-mers, with majority of the K-mers shown being in both organisms, with a few exceptions of ‘ALAL’ in Salmonella and ‘LLLA’ in E.coli, the shared K-mers do vary on the amount of representation In the gene.
...
```
A data frame of 5 length K-mers was created for Salmonella to be able to be able to sort over represented and underrepresented 5 length k-mers.
...
```
A data frame of 5 length K-mers was created for E.coli to be able to be able to sort over represented and underrepresented 5 length k-mers.
