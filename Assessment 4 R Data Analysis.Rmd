...
The variation in K-mer expression in *Salmonella* and *E.coli* is due to the differnces in nucleotide sequences which create the protiens, which then create the 3,4,5 length K-mers.
